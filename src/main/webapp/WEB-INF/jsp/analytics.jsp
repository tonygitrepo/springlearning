	...
	<nav>
	  <div id="menubar">
        <ul id="nav">
          ...
          <li  class="current"><a href="<c:url value="/fetchtweets/analytics.html"/>">Analytics</a></li>
		   	...
		   	<div class="col-lg-6">
						<form:form id="myForm" method="post"
							class="bs-example form-horizontal" commandName="readFromTwitter">
								...
								<table>
								<tr><td><p class="highlight">Feeds for Analytics / Feedback / Trend Evalution </p>
										<p class="highlight" style="font-size:100%">User Timeline :</b></br>
										Tweets posted by the <b>(business) User</b> on the timeline as Promotions / Brand survey etc .</br></p></td>
									<td>										
									<button style="width:100px" class="button_small" name="param1" class="btn btn-primary" value="USERTIMELINE">Fetch Feeds</button>									
									</td>
								</tr>
								</table>
							</fieldset>
